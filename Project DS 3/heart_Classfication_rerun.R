...
processedWithHeader_cleveland <- read_csv("~/Documents/Freie/IFA/WiSe 22-23/Data Science/Week 4/processedWithHeader.cleveland.data",  
...
metric <- evalm(list(log,rf,blog,knn), 
                ...
                rlinethick=0.8,fsize=15, silent = TRUE)
